...
CallbackReturn robotImuSensor::on_activate(const rclcpp_lifecycle::State&)
{
  ...
  {
    RCLCPP_WARN_THROTTLE(rclcpp::get_logger("robotImuSensor"), *node_->get_clock(), 5000,
...
PLUGINLIB_EXPORT_CLASS(robot_hardware_interfaces::robotImuSensor, hardware_interface::SensorInterface)
